...
public class JavaBank extends JFrame {
    ...
    //combobox to display account types 
    ...
    private void createUserInterface() {
     ...
     // set up DisplayJButton
        ...
        accountTypes.addActionListener(new ActionListener()//anonymous inner class
        {
        	//event handler called when transaction jbutton is clicked
        	public void actionPerformed(ActionEvent event) {
    ...
    private void CreateAccountJButtonActionPerformed(ActionEvent event) throws MyException {
    	...
    	//this catch will catch either NumberFormatExceptions or InputMismatchExceptions
    	//catch(NumberFormatException | InputMismatchException e) {
    	//	JOptionPane.showMessageDialog(null, "Incorrect numeric value entered");
    	//}
    	catch(Exception e) {
    		throw new MyException("unhandled");
    	}//end catch
    	finally {
    		resetTextFields();  
    	}//end finally
        	...
        	if ((noAccounts <= 9) & (Name != "") & (Accountnum != 0))  {   
        		...
        		else if (actType.equals(AccountType.SAVINGS)) {
        			myAccounts[noAccounts] = new Account(Name,Accountnum,Balance, actType);        		
            		AccountNames[noAccounts] = "USED";
            		displayAccountDetails(myAccounts[noAccounts]);
            		noAccounts ++;
    ...
    private void displayAccountDetails(AbstractBankAccount myAccounts) {
    	displayJTextArea.append("" + myAccounts.toString());
    	}
